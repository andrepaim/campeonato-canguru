  ...
  return (
    <div className="p-4">
      <div className="text-center mb-6">
        <img src="/icon-canguru.jpg" alt="Brasileirão Canguru" className="w-10 h-10 mx-auto mb-2 rounded-xl" />
        <h1 className="text-2xl font-bold text-white">Brasileirão Canguru 2026</h1>
